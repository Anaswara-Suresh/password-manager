...
void LoginWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->loginSuccessful((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        case 1: _t->onLoginClicked(); break;
        case 2: _t->onRegisterClicked(); break;
        case 3: _t->onResetPasswordClicked(); break;
        case 4: _t->onShowPasswordToggled((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 5: _t->handleAutoLock(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LoginWindow::*)(const QByteArray & )>(_a, &LoginWindow::loginSuccessful, 0))
            return;
    }
}
...
// SIGNAL 0
void LoginWindow::loginSuccessful(const QByteArray & _t1)
{
