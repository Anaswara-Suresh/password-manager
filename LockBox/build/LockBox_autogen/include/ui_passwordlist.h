...
public:
    ...
    QPushButton *btnImportVault;
    QPushButton *btnExportVault;
    ...
    void setupUi(QWidget *PasswordList)
    {
        ...
        importExportLayout->setObjectName("importExportLayout");
        leftSpacer = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);

        importExportLayout->addItem(leftSpacer);

        btnImportVault = new QPushButton(PasswordList);
        btnImportVault->setObjectName("btnImportVault");
        btnImportVault->setMinimumSize(QSize(140, 32));

        importExportLayout->addWidget(btnImportVault);

        btnExportVault = new QPushButton(PasswordList);
        btnExportVault->setObjectName("btnExportVault");
        btnExportVault->setMinimumSize(QSize(140, 32));

        importExportLayout->addWidget(btnExportVault);


        verticalLayout->addLayout(importExportLayout);
...
"      "));
    ...
    void retranslateUi(QWidget *PasswordList)
    {
        ...
        btnImportVault->setText(QCoreApplication::translate("PasswordList", "Import Vault", nullptr));
        btnExportVault->setText(QCoreApplication::translate("PasswordList", "Export Vault", nullptr));
